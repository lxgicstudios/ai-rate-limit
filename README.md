...
![npm](https://img.shields.io/npm/v/ai-rate-limit)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-rate-limit)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Rate limiting and throttling implementation tools

Rate limiting middleware. Protects APIs with configurable request limits and blocking.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-rate-limit.svg)](https://badge.fury.io/js/ai-rate-limit)
